...
public class TaskCopyToReq
		extends ReqCommand
{
	public TaskCopyToReq()
	{
		super();
	...
	public TaskCopyToReq(int sequence, String taskId, String projectId)
	{
		this();
	...
	@Override
	public TaskCopyToReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(TaskCopyToReq.class);
