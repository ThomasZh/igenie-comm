...
public class SyncTaskUncompletedReq
		extends ReqCommand
{
	public SyncTaskUncompletedReq()
	{
		super();
	...
	public SyncTaskUncompletedReq(int lastTryTime)
	{
		this();
	...
	@Override
	public SyncTaskUncompletedReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
		logger.info("from tlv:(tag=" + Command.SYNC_TASKPRO_UNCOMPLETED_REQ + ", child=2) to command");
			...
			throws UnsupportedEncodingException
	{
		...
		TlvObject tlv = new TlvObject(Command.SYNC_TASKPRO_UNCOMPLETED_REQ);
		tlv.push(tSequence);
		tlv.push(tLastTryTime);

		logger.info("from command to tlv package:(tag=" + Command.SYNC_TASKPRO_UNCOMPLETED_REQ
	...
	private final static Logger logger = LoggerFactory.getLogger(SyncTaskUncompletedReq.class);
}
