...
public class SyncUncompletedProjectResp
		extends RespCommand
{
	public SyncUncompletedProjectResp()
	{
		this.setTag(Command.SYNC_PROJECT_UNCOMPLETED_RESP);
	}

	public SyncUncompletedProjectResp(int sequence, short state, List<ProjectMaster> projects, int timestamp)
	{
		this();
	...
	@Override
	public SyncUncompletedProjectResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
		int childCount = 4;
	...
	private final static Logger logger = LoggerFactory.getLogger(SyncUncompletedProjectResp.class);
