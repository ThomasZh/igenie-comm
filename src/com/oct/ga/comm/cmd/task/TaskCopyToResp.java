...
public class TaskCopyToResp
		extends RespCommand
{
	public TaskCopyToResp()
	{
		this.setTag(Command.TASK_COPY_TO_RESP);
	}

	public TaskCopyToResp(int sequcence, short respState)
	{
		this();
	...
	@Override
	public TaskCopyToResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(TaskCopyToResp.class);
