...
public class SyncTodayTaskResp
		extends RespCommand
{
	public SyncTodayTaskResp()
	{
		this.setTag(Command.SYNC_TODAY_TASK_RESP);
	}

	public SyncTodayTaskResp(short state, String json, int timestamp)
	{
		this();
			...
			throws UnsupportedEncodingException
	{
		...
		TlvObject tlv = new TlvObject(Command.SYNC_TODAY_TASK_RESP);
		...
		logger.info("from command to tlv package:(tag=" + Command.SYNC_TODAY_TASK_RESP + ", child=4, length="
				+ tlv.getLength() + ")");
	...
	@Override
	public SyncTodayTaskResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(SyncTodayTaskResp.class);
