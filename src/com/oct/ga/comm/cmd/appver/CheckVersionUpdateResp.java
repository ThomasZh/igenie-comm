...
public class CheckVersionUpdateResp
		extends RespCommand
{
	public CheckVersionUpdateResp()
	{
		this.setTag(Command.CHECK_VERSION_UPGRADE_RESP);
	}

	public CheckVersionUpdateResp(int sequence, short respState)
	{
		this();
	...
	@Override
	public CheckVersionUpdateResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(CheckVersionUpdateResp.class);
