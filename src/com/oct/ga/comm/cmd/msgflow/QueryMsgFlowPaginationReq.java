...
public class QueryMsgFlowPaginationReq
		extends ReqCommand
{
	public QueryMsgFlowPaginationReq()
	{
		super();
	...
	public QueryMsgFlowPaginationReq(short pageNum, short pageSize)
	{
		this();
	...
	@Override
	public QueryMsgFlowPaginationReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryMsgFlowPaginationReq.class);
