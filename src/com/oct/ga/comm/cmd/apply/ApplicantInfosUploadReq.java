...
public class ApplicantInfosUploadReq
		extends ReqCommand
{
	public ApplicantInfosUploadReq()
	{
		super();
	...
	public ApplicantInfosUploadReq(int sequence, String activityId, List<GaApplicantCell> contactInfo,
	...
	@Override
	public ApplicantInfosUploadReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ApplicantInfosUploadReq.class);
