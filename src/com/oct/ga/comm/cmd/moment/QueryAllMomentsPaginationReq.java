...
public class QueryAllMomentsPaginationReq
		extends ReqCommand
{
	public QueryAllMomentsPaginationReq()
	{
		super();
	...
	@Override
	public QueryAllMomentsPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryAllMomentsPaginationReq.class);
