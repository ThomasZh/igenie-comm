...
public class QueryMomentCommentPaginationReq
		extends ReqCommand
{
	public QueryMomentCommentPaginationReq()
	{
		super();
	...
	public QueryMomentCommentPaginationReq(String momentId, short pageNum, short pageSize)
	{
		this();
	...
	public QueryMomentCommentPaginationReq(int sequence, String momentId, short pageNum, short pageSize)
	{
	...
	@Override
	public QueryMomentCommentPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryMomentCommentPaginationReq.class);
