		...
		extends RespCommand
{
	...
	public DndSetResp(int sequence, short respState)
	{
		this();
	...
	@Override
	public DndSetResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(DndSetResp.class);
