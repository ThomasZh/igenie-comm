...
public class ActivityQueryMyHistoryPaginationResp
		extends RespCommand
{
	public ActivityQueryMyHistoryPaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_MY_HISTORY_PAGINATION_RESP);
	}

	public ActivityQueryMyHistoryPaginationResp(short respState, List<ActivitySubscribeInfo> activities)
	{
		this();
	...
	public ActivityQueryMyHistoryPaginationResp(int sequence, short respState, List<ActivitySubscribeInfo> activities)
	{
	...
	@Override
	public ActivityQueryMyHistoryPaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryMyHistoryPaginationResp.class);
