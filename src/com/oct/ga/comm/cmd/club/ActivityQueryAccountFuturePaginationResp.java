...
public class ActivityQueryAccountFuturePaginationResp
		extends RespCommand
{
	public ActivityQueryAccountFuturePaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_ACCOUNT_FUTURE_PAGINATION_RESP);
	}

	public ActivityQueryAccountFuturePaginationResp(short respState, List<ActivitySubscribeInfo> activities)
	{
		this();
	...
	public ActivityQueryAccountFuturePaginationResp(int sequence, short respState,
	...
	@Override
	public ActivityQueryAccountFuturePaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryAccountFuturePaginationResp.class);
