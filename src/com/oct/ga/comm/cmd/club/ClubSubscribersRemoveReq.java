...
public class ClubSubscribersRemoveReq
		extends ReqCommand
{
	public ClubSubscribersRemoveReq()
	{
		super();
	...
	public ClubSubscribersRemoveReq(String clubId)
	{
		this();
	...
	public ClubSubscribersRemoveReq(String clubId, String[] ids)
	{
		this(clubId);
	...
	public ClubSubscribersRemoveReq(int sequence, String clubId, String[] ids)
	{
		this(clubId, ids);
	...
	@Override
	public ClubSubscribersRemoveReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ClubSubscribersRemoveReq.class);
