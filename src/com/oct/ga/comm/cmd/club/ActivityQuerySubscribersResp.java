...
public class ActivityQuerySubscribersResp
		extends RespCommand
{
	public ActivityQuerySubscribersResp()
	{
	...
	@Override
	public ActivityQuerySubscribersResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQuerySubscribersResp.class);
