...
public class ActivityQuerySubscribePaginationResp
		extends RespCommand
{
	public ActivityQuerySubscribePaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_SUBSCRIBE_PAGINATION_RESP);
	}

	public ActivityQuerySubscribePaginationResp(short respState, List<ActivitySubscribeInfo> activities)
	{
		this();
	...
	public ActivityQuerySubscribePaginationResp(int sequence, short respState, List<ActivitySubscribeInfo> activities)
	{
	...
	@Override
	public ActivityQuerySubscribePaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQuerySubscribePaginationResp.class);
