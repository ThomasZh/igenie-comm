...
/**
 * query my subscribe future(start>today) activities by pagination.
 * 
 * @author thomas
 * 
 */
public class ActivityQueryMyFuturePaginationReq
		extends ReqCommand
{
	public ActivityQueryMyFuturePaginationReq()
	{
		super();
	...
	public ActivityQueryMyFuturePaginationReq(short pageNum, short pageSize)
	{
		this();
	...
	public ActivityQueryMyFuturePaginationReq(int sequence, short pageNum, short pageSize)
	{
	...
	@Override
	public ActivityQueryMyFuturePaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryMyFuturePaginationReq.class);
