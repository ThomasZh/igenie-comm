...
public class ClubSubscribersRemoveResp
		extends RespCommand
{
	public ClubSubscribersRemoveResp()
	{
		this.setTag(Command.CLUB_SUBSCRIBER_REMOVE_RESP);
	}

	public ClubSubscribersRemoveResp(short respState, String clubId)
	{
		this();
	...
	public ClubSubscribersRemoveResp(int sequence, short respState, String clubId)
	{
	...
	@Override
	public ClubSubscribersRemoveResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ClubSubscribersRemoveResp.class);
