 ...
 * 
 */
public class ActivityQueryAccountFuturePaginationReq
		extends ReqCommand
{
	public ActivityQueryAccountFuturePaginationReq()
	{
		super();
	...
	public ActivityQueryAccountFuturePaginationReq(short pageNum, short pageSize)
	{
		this();
	...
	public ActivityQueryAccountFuturePaginationReq(int sequence, short pageNum, short pageSize)
	{
	...
	public ActivityQueryAccountFuturePaginationReq(int sequence, String accountId, short pageNum, short pageSize)
	{
	...
	@Override
	public ActivityQueryAccountFuturePaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryAccountFuturePaginationReq.class);
