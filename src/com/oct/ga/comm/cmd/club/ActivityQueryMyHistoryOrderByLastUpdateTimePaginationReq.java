...
public class ActivityQueryMyHistoryOrderByLastUpdateTimePaginationReq
		extends ReqCommand
{
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationReq()
	{
		super();
	...
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationReq(short pageNum, short pageSize)
	{
		this();
	...
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationReq(int sequence, short pageNum, short pageSize)
	{
	...
	@Override
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory
			.getLogger(ActivityQueryMyHistoryOrderByLastUpdateTimePaginationReq.class);
