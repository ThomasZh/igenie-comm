...
public class ActivityQueryHistoryPaginationReq
		extends ReqCommand
{
	public ActivityQueryHistoryPaginationReq()
	{
		super();
	...
	{
		TlvObjectExt root = new TlvObjectExt(Command.ACTIVITY_QUERY_HISTORY_PAGINATION_REQ);
	...
	@Override
	public ActivityQueryHistoryPaginationReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
		logger.info("from tlv:(tag=" + Command.ACTIVITY_QUERY_HISTORY_PAGINATION_REQ + ", child=4) to command");
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryHistoryPaginationReq.class);
