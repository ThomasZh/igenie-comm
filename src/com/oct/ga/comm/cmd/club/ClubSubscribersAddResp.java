...
public class ClubSubscribersAddResp
		extends RespCommand
{
	public ClubSubscribersAddResp()
	{
		this.setTag(Command.CLUB_SUBSCRIBER_ADD_RESP);
	}

	public ClubSubscribersAddResp(short respState, String clubId)
	{
		this();
	...
	public ClubSubscribersAddResp(int sequence, short respState, String clubId)
	{
	...
	@Override
	public ClubSubscribersAddResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ClubSubscribersAddResp.class);
