...
public class ActivityQuerySubscribeOrderByCreateTimePaginationResp
		extends RespCommand
{
	public ActivityQuerySubscribeOrderByCreateTimePaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_SUBSCRIBE_ORDER_BY_CREATRE_TIME_PAGINATION_RESP);
	}

	public ActivityQuerySubscribeOrderByCreateTimePaginationResp(short respState,
	...
	public ActivityQuerySubscribeOrderByCreateTimePaginationResp(int sequence, short respState,
			List<ActivitySubscribeDetailInfo> activities)
	{
	...
	@Override
	public ActivityQuerySubscribeOrderByCreateTimePaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private List<ActivitySubscribeDetailInfo> activities;
	...
	private final static Logger logger = LoggerFactory
			.getLogger(ActivityQuerySubscribeOrderByCreateTimePaginationResp.class);
