...
public class ActivityQueryFuturePaginationResp
		extends RespCommand
{
	public ActivityQueryFuturePaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_FUTURE_PAGINATION_RESP);
	}

	public ActivityQueryFuturePaginationResp(short respState, List<ActivitySubscribeInfo> activities)
	{
		this();
	...
	public ActivityQueryFuturePaginationResp(int sequence, short respState, List<ActivitySubscribeInfo> activities)
	{
	...
	@Override
	public ActivityQueryFuturePaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryFuturePaginationResp.class);
