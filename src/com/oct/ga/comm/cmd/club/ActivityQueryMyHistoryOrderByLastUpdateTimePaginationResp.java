...
public class ActivityQueryMyHistoryOrderByLastUpdateTimePaginationResp
		extends RespCommand
{
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_MY_HISTORY_ORDERBY_LAST_UPDATE_TIME_PAGINATION_RESP);
	}

	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationResp(short respState,
	...
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationResp(int sequence, short respState,
			List<ActivitySubscribeInfo> activities)
	{
	...
	@Override
	public ActivityQueryMyHistoryOrderByLastUpdateTimePaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory
			.getLogger(ActivityQueryMyHistoryOrderByLastUpdateTimePaginationResp.class);
