...
public class ClubSubscribersUpdateReq
		extends ReqCommand
{
	public ClubSubscribersUpdateReq()
	{
		super();
	...
	public ClubSubscribersUpdateReq(String clubId)
	{
		this();
	...
	public ClubSubscribersUpdateReq(String clubId, String[] ids)
	{
		this(clubId);
	...
	public ClubSubscribersUpdateReq(int sequence, String clubId, String[] ids)
	{
		this(clubId, ids);
	...
	@Override
	public ClubSubscribersUpdateReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ClubSubscribersUpdateReq.class);
