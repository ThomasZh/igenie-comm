...
public class ActivityQueryAccountHistoryPaginationResp
		extends RespCommand
{
	public ActivityQueryAccountHistoryPaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_ACCOUNT_HISTORY_PAGINATION_RESP);
	}

	public ActivityQueryAccountHistoryPaginationResp(short respState, List<ActivitySubscribeInfo> activities)
	{
		this();
	...
	public ActivityQueryAccountHistoryPaginationResp(int sequence, short respState,
	...
	@Override
	public ActivityQueryAccountHistoryPaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryAccountHistoryPaginationResp.class);
