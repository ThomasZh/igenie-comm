...
public class ActivityQueryMyFuturePaginationResp
		extends RespCommand
{
	public ActivityQueryMyFuturePaginationResp()
	{
		this.setTag(Command.ACTIVITY_QUERY_MY_FUTURE_PAGINATION_RESP);
	}

	public ActivityQueryMyFuturePaginationResp(short respState, List<ActivitySubscribeInfo> activities)
	{
		this();
	...
	public ActivityQueryMyFuturePaginationResp(int sequence, short respState, List<ActivitySubscribeInfo> activities)
	{
	...
	@Override
	public ActivityQueryMyFuturePaginationResp decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryMyFuturePaginationResp.class);
