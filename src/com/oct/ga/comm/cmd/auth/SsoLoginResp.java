		...
		extends RespCommand
{
	public SsoLoginResp()
	{
		this.setTag(Command.SSO_LOGIN_RESP);
	}

	public SsoLoginResp(short respState, String accountId, String sessionToken)
	{
		this();
	...
	@Override
	public SsoLoginResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(SsoLoginResp.class);
