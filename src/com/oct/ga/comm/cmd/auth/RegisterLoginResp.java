...
public class RegisterLoginResp
		extends RespCommand
{
	public RegisterLoginResp()
	{
		this.setTag(Command.REGISTER_LOGIN_RESP);
	}

	public RegisterLoginResp(short respState, String accountId, String sessionToken)
	{
		this();
	...
	@Override
	public RegisterLoginResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(RegisterLoginResp.class);
