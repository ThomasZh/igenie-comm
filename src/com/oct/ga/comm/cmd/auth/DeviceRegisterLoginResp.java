...
public class DeviceRegisterLoginResp
		extends RespCommand
{
	public DeviceRegisterLoginResp()
	{
		this.setTag(Command.DEVICE_REGISTER_LOGIN_RESP);
	}

	public DeviceRegisterLoginResp(short respState, String accountId, String sessionToken)
	{
		this();
	...
	@Override
	public DeviceRegisterLoginResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(DeviceRegisterLoginResp.class);
