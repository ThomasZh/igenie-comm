		...
		extends RespCommand
{
	public LoginResp()
	{
		this.setTag(Command.LOGIN_RESP);
	}

	public LoginResp(short respState, String accountId, String sessionToken)
	{
		this();
	...
	@Override
	public LoginResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(LoginResp.class);
}
