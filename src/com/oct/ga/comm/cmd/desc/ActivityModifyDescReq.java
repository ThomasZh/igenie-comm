...
public class ActivityModifyDescReq
		extends ReqCommand
{
	public ActivityModifyDescReq()
	{
		super();
	...
	public ActivityModifyDescReq(int sequence, String activityId, GaDescChapter chapter)
	{
		this();
	...
	@Override
	public ActivityModifyDescReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ActivityModifyDescReq.class);
