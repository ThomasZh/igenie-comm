		...
		extends RespCommand
{
	...
	{
		this.setTag(Command.CHANGE_PASSWORD_RESP);
	}

	public ChangePasswordResp(short respState)
	{
		this();
	...
	@Override
	public ChangePasswordResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ChangePasswordResp.class);
