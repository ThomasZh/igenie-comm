...
public class BindMargePhoneReq
		extends ReqCommand
{
	public BindMargePhoneReq()
	{
		super();
	...
	public BindMargePhoneReq(String phone, String md5pwd, String code)
	{
		this();
	...
	public BindMargePhoneReq(int sequence, String phone, String md5pwd, String code)
	{
	...
	@Override
	public BindMargePhoneReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(BindMargePhoneReq.class);
