		...
		extends RespCommand
{
	...
	{
		this.setTag(Command.FORGOT_PASSWORD_RESP);
	}

	public ForgotPasswordResp(short respState)
	{
		this();
	...
	@Override
	public ForgotPasswordResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ForgotPasswordResp.class);
