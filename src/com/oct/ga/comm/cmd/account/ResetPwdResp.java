		...
		extends RespCommand
{
	public ResetPwdResp()
	{
		this.setTag(Command.RESET_PASSWORD_RESP);
	}

	public ResetPwdResp(short respState)
	{
		this();
	...
	@Override
	public ResetPwdResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ResetPwdResp.class);
