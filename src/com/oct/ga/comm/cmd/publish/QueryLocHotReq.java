...
public class QueryLocHotReq
		extends ReqCommand
{
	public QueryLocHotReq()
	{
		super();
	...
	public QueryLocHotReq(short pageNum, short pageSize)
	{
		this();
	...
	public QueryLocHotReq(int sequence, short pageNum, short pageSize)
	{
	...
	@Override
	public QueryLocHotReq decode(TlvObject tlv)
			throws UnsupportedEncodingException
	{
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryLocHotReq.class);
}
